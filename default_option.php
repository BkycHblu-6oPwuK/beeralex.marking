<?
$localOptionsFileName = 'beeralex_marking_options.php';
...
if(file_exists($bitrixPath . $basePathToOptions)) {
    $beeralex_marking_default_option = include $bitrixPath . $basePathToOptions;
} elseif (file_exists($localPath . $basePathToOptions)) {
    $beeralex_marking_default_option = include $localPath . $basePathToOptions;
}